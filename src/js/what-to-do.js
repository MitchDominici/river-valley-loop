...
class WhatToDoPage {
            ...
            'Hermann': [
                {
                    ...
                    image: 'https://mitchdominici.github.io/river-valley-loop/images/towns/hermann/hermann-1.jpg'
                },
                {
                    ...
                    image: 'https://mitchdominici.github.io/river-valley-loop/images/towns/hermann/hermann-2.jpg'
                }
            ],
            'New Haven': [
                {
                    ...
                    image: 'https://mitchdominici.github.io/river-valley-loop/images/towns/new-haven/new-haven-1.jpg'
                }
            ]
    ...
    renderBusinesses(day) {
        ...
        for (const [town, businesses] of Object.entries(this.businesses)) {
            const filteredBusinesses = day === 'all'
                ? businesses
