class TownsPage {
        ...
        this.towns = [
            {
                ...
                images: Array.from({length: 3}, (_, i) => `https://mitchdominici.github.io/river-valley-loop/images/towns/hermann/hermann-${i + 1}.jpg`),
                sponsors: [
            ...
            },
            {
                ...
                images: Array.from({length: 3}, (_, i) => `https://mitchdominici.github.io/river-valley-loop/images/towns/new-haven/new-haven-${i + 1}.jpg`),
                sponsors: [
            ...
            },
            {
                ...
                description: "A historic river community that exemplifies small-town Missouri charm. Lyon features historic buildings and a close-knit community atmosphere. The town's strategic location along the river made it an important trading post in early Missouri history.",
                images: Array.from({length: 3}, (_, i) => `https://mitchdominici.github.io/river-valley-loop/images/towns/lyon/lyon-${i + 1}.jpg`),
                sponsors: [
            ...
            {
                name: "Beaufort",
                image: "https://mitchdominici.github.io/river-valley-loop/images/towns/beaufort/beaufort-1.jpg",
                description: "Founded in 1849, Beaufort is known for its scenic beauty and agricultural heritage. The town maintains strong ties to its farming roots while embracing modern amenities. Its rolling hills and pristine countryside offer visitors a peaceful retreat.",
                images: Array.from({length: 3}, (_, i) => `https://mitchdominici.github.io/river-valley-loop/images/towns/beaufort/beaufort-${i + 1}.jpg`),
                sponsors: [
            ...
            },
            {
                ...
                description: "A welcoming community established along the railroad in 1901. Gerald combines traditional values with progressive development. The town is known for its annual Railroad Days festival and strong community spirit.",
                images: Array.from({length: 3}, (_, i) => `https://mitchdominici.github.io/river-valley-loop/images/towns/gerald/gerald-${i + 1}.jpg`),
                sponsors: [
            ...
            {
                name: "Rosebud",
                image: "https://mitchdominici.github.io/river-valley-loop/images/towns/rosebud/rosebud-1.jpg",
                description: "Named for the wild roses that once covered its hills, Rosebud is a charming small town known for its antique shops and friendly atmosphere. The town's well-preserved main street features historic buildings and unique local businesses.",
                images: Array.from({length: 3}, (_, i) => `https://mitchdominici.github.io/river-valley-loop/images/towns/rosebud/rosebud-${i + 1}.jpg`),
                sponsors: [
            ...
            {
                name: "Owensville",
                image: "https://mitchdominici.github.io/river-valley-loop/images/towns/owensville/owensville-1.jpg",
                description: "Founded in 1886, Owensville serves as a regional hub combining rural charm with modern amenities. The town is known for its excellent schools, community events, and the annual Gasconade County Fair.",
                images: Array.from({length: 3}, (_, i) => `https://mitchdominici.github.io/river-valley-loop/images/towns/owensville/owensville-${i + 1}.jpg`),
                sponsors: [
            ...
            {
                name: "Stony Hill",
                image: "https://mitchdominici.github.io/river-valley-loop/images/towns/stony-hill/stony-hill-1.jpg",
                description: "A historic community known for its scenic views and rich agricultural heritage. Stony Hill's elevated location offers panoramic views of the surrounding countryside and vineyards.",
                images: Array.from({length: 3}, (_, i) => `https://mitchdominici.github.io/river-valley-loop/images/towns/stony-hill/stony-hill-${i + 1}.jpg`),
                sponsors: [
            ...
            },
            {
                ...
                description: "Named for its early Swiss settlers, this small community preserves its unique cultural heritage. The area is known for its traditional architecture, dairy farming, and cheese-making traditions.",
                images: Array.from({length: 3}, (_, i) => `https://mitchdominici.github.io/river-valley-loop/images/towns/swiss/swiss-${i + 1}.jpg`),
                sponsors: [
            ...
            },
            {
                ...
                description: "Situated along the Missouri River, Berger offers stunning river views and rich German heritage. The town is known for its historic buildings, traditional festivals, and proximity to wine country.",
                images: Array.from({length: 3}, (_, i) => `https://mitchdominici.github.io/river-valley-loop/images/towns/berger/berger-${i + 1}.jpg`),
                sponsors: [
    ...
    changeImage(direction) {
        ...
        window.townsPage.currentImageIndex = (window.townsPage.currentImageIndex + direction + imagesLength) % imagesLength;
        ...
        this.modalContent.innerHTML = `
            ...
            <div class="border-t pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ${window.townsPage.currentTown.sponsors.map(sponsor => `
